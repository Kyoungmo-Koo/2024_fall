...
int NUM_OF_POSITIONS_RASTER = 6264;
int NUM_OF_POSITIONS_RADIAL = 6264;
int NUM_OF_BYTES_PER_CHUNK;
int NUM_OF_BYTES_PER_CHUNK_RASTER = 12528;
...
void HAL_UART_TxCpltCallback (UART_HandleTypeDef *huart){
	if(count % 2 == 1){
		...
		HAL_SPI_Transmit_DMA(&hspi2, &rxData[3132], NUM_OF_BYTES_PER_CHUNK);
	}
}
...
void HAL_SPI_TxCpltCallback (SPI_HandleTypeDef *hspi){
	...
	if(count % 2 == 1){
		...
		HAL_SPI_Receive_DMA(&hspi2, &txData[3132], NUM_OF_BYTES_PER_CHUNK);
	}
}
